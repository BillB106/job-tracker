...
function buildColumns() {
  ...
  return [
    ...
    { field: "posted_date", headerName: "Posted (approx)", width: 140, ...editableText },
    { field: "posted", headerName: "Posted", width: 150, ...editableText },
    { field: "applicants", headerName: "Applicants / Clicks", width: 160, ...editableText },
    { field: "apply_method", headerName: "Apply Method", width: 130, ...editableText },
...
async function initGrid() {
  ...
  const gridOptions = {
    ...
    rowClassRules: {
      ...
      "prio-backpocket": (p) => p.data && p.data.prio === "Keep in backpocket",
